...
class ApplyFarFieldProcess(KratosMultiphysics.Process):
    def __init__(self, Model, settings ):
        ...
        self.fluid_model_part.ProcessInfo.SetValue(KratosMultiphysics.INITIAL_PENALTY, 10.0)
        ...
        self.fluid_model_part.ProcessInfo.SetValue(KratosMultiphysics.TEMPERATURE, 10.0)
        # self.fluid_model_part.ProcessInfo.SetValue(CPFApp.ROTATION_ANGLE, 0.0)
