...
PYBIND11_MODULE(KratosCompressiblePotentialFlowApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POTENTIAL_LAGRANGE_MULTIPLIER_0);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POTENTIAL_LAGRANGE_MULTIPLIER_1);

    //Embedded variables
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GEOMETRY_DISTANCE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GEOMETRY_ELEMENTAL_DISTANCES)
