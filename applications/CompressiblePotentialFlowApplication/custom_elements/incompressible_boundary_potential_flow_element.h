...
#if !defined(KRATOS_INCOMPRESSIBLE_BOUNDARY_POTENTIAL_FLOW_ELEMENT_H)
#define KRATOS_INCOMPRESSIBLE_BOUNDARY_POTENTIAL_FLOW_ELEMENT_H
...
class IncompressibleBoundaryPotentialFlowElement : public Element
{
public:
    ...
    /// Pointer definition of IncompressibleBoundaryPotentialFlowElement
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(IncompressibleBoundaryPotentialFlowElement);
     ...
     */
    explicit IncompressibleBoundaryPotentialFlowElement(IndexType NewId = 0){}

    /**
     * Constructor using an array of nodes
     */
    IncompressibleBoundaryPotentialFlowElement(IndexType NewId, const NodesArrayType& ThisNodes)
        : Element(NewId, ThisNodes){}

    /**
     * Constructor using Geometry
     */
    IncompressibleBoundaryPotentialFlowElement(IndexType NewId, GeometryType::Pointer pGeometry)
        : Element(NewId, pGeometry){}

    /**
     * Constructor using Properties
     */
    IncompressibleBoundaryPotentialFlowElement(IndexType NewId,
     ...
     * Copy Constructor
     */
    IncompressibleBoundaryPotentialFlowElement(IncompressibleBoundaryPotentialFlowElement const& rOther) = delete;

    /**
     * Move Constructor
     */
    IncompressibleBoundaryPotentialFlowElement(IncompressibleBoundaryPotentialFlowElement&& rOther) = delete;

    /**
     * Destructor
     */
    ~IncompressibleBoundaryPotentialFlowElement() override{}
    ...
    /// Assignment operator.
    IncompressibleBoundaryPotentialFlowElement& operator=(IncompressibleBoundaryPotentialFlowElement const& rOther) = delete;

    /// Move operator.
    IncompressibleBoundaryPotentialFlowElement& operator=(IncompressibleBoundaryPotentialFlowElement&& rOther) = delete;
...
}; // Class IncompressibleBoundaryPotentialFlowElement
