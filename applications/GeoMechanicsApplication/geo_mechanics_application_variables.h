...
namespace Kratos
{
    ...
    KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, int, NUMBER_OF_UMAT_C_PARAMETER)
    KRATOS_DEFINE_APPLICATION_VARIABLE(GEO_MECHANICS_APPLICATION, int, NUMBER_OF_UMAT_PHI_PARAMETER)
