...
namespace Kratos
{
        ...
        const ProcessInfo& rCurrentProcessInfo)
    {
        ...
        // Initialize water properties at initial
        ElementVariables Variables;
        this->InitializeElementVariables(Variables, rCurrentProcessInfo);
        const PropertiesType& rProp = this->GetProperties();
        Variables.WaterDensity = rProp[DENSITY_WATER];
        Variables.WaterViscosity = rProp[DYNAMIC_VISCOSITY];
    ...
    {
        this->InitialGaussWaterDensity(rVariables);
        this->InitialGaussWaterViscosity(rVariables);
    }

    // ============================================================================================
    // ============================================================================================
    template<unsigned int TDim, unsigned int TNumNodes>
    void TransientThermalElement<TDim, TNumNodes>::InitialGaussWaterDensity(
        ElementVariables& rVariables)
    {
    ...
    // ============================================================================================
    template<unsigned int TDim, unsigned int TNumNodes>
    void TransientThermalElement<TDim, TNumNodes>::InitialGaussWaterViscosity(
        ElementVariables& rVariables)
    {
        double temp = inner_prod(rVariables.Np, rVariables.TemperatureVector);
