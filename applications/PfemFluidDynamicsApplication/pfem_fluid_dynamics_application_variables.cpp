...
KRATOS_CREATE_VARIABLE(double, INERTIAL_FORCES_NORM)
KRATOS_CREATE_VARIABLE(double, VISCOUS_FORCES_NORM)
KRATOS_CREATE_VARIABLE(double, VOLUMETRIC_FORCES_NORM)
KRATOS_CREATE_VARIABLE(double, EXTERNAL_FORCES_NORM)
KRATOS_CREATE_VARIABLE(double, RHS_ELEMENTAL_NORM)
///@}
