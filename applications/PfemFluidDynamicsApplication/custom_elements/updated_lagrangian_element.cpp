...
namespace Kratos
{
  ...
  void UpdatedLagrangianElement<TDim>::CalculateGeometryData(Vector &rGaussWeights)
  {
    ...
    // rGeom.ShapeFunctionsIntegrationPointsGradients(DN_DX,DetJ,GeometryData::IntegrationMethod::GI_GAUSS_1);
    const GeometryType::IntegrationPointsArrayType &IntegrationPoints = rGeom.IntegrationPoints(GeometryData::IntegrationMethod::GI_GAUSS_1);
  ...
  template <>
  void UpdatedLagrangianElement<2>::CalcVolumetricDefRate(const ShapeFunctionDerivativesType &rDN_DX,
  ...
  template <unsigned int TDim>
  void UpdatedLagrangianElement<TDim>::CalcSpatialVelocityGrad(MatrixType &invFgrad,
  ...
  template <>
  void UpdatedLagrangianElement<2>::CheckStrain1(double &VolumetricDefRate,
                                                 MatrixType &SpatialVelocityGrad)
  {
  ...
  template <>
  void UpdatedLagrangianElement<2>::CalcMDGreenLagrangeMaterial(MatrixType &Fgrad,
                                                                MatrixType &VelDefgrad,
  ...
  template <>
  void UpdatedLagrangianElement<3>::CalcMDGreenLagrangeMaterial(MatrixType &Fgrad,
                                                                MatrixType &VelDefgrad,
                                                                VectorType &MDGreenLagrangeMaterial)
  {
  ...
  template <>
  void UpdatedLagrangianElement<2>::CalcSpatialDefRate(VectorType &MDGreenLagrangeMaterial,
                                                       MatrixType &invFgrad,
  ...
  template <>
  void UpdatedLagrangianElement<3>::CalcSpatialDefRate(VectorType &MDGreenLagrangeMaterial,
                                                       MatrixType &invFgrad,
                                                       VectorType &SpatialDefRate)
  {
  ...
  template <>
  void UpdatedLagrangianElement<2>::CalcDeviatoricInvariant(VectorType &SpatialDefRate,
  ...
  template <>
  void UpdatedLagrangianElement<2>::CalcEquivalentStrainRate(VectorType &SpatialDefRate,
  ...
  template <>
  void UpdatedLagrangianElement<3>::CalcDeviatoricInvariant(VectorType &SpatialDefRate,
                                                            double &DeviatoricInvariant)
  {
  ...
  template <>
  void UpdatedLagrangianElement<3>::CalcEquivalentStrainRate(VectorType &SpatialDefRate,
                                                             double &EquivalentStrainRate)
  {
    EquivalentStrainRate = sqrt(2.0 * (SpatialDefRate[0] * SpatialDefRate[0] +
                                       SpatialDefRate[1] * SpatialDefRate[1] +
  ...
  template <>
  double UpdatedLagrangianElement<2>::CalcNormalProjectionDefRate(VectorType &SpatialDefRate)
  {
  ...
  template <>
  double UpdatedLagrangianElement<3>::CalcNormalProjectionDefRate(VectorType &SpatialDefRate)
  {
    double NormalProjSpatialDefRate = 0;
    GeometryType &rGeom = this->GetGeometry();
    const SizeType NumNodes = rGeom.PointsNumber();
  ...
  template <>
  void UpdatedLagrangianElement<2>::CheckStrain2(MatrixType &SpatialVelocityGrad,
                                                 MatrixType &Fgrad,
                                                 MatrixType &VelDefgrad)
  {
  ...
  template <>
  bool UpdatedLagrangianElement<2>::CheckStrain3(VectorType &SpatialDefRate,
                                                 MatrixType &SpatialVelocityGrad)
  {
    bool computeElement = true;
  ...
  template <>
  bool UpdatedLagrangianElement<3>::CheckStrain3(VectorType &SpatialDefRate,
                                                 MatrixType &SpatialVelocityGrad)
  {
    bool computeElement = true;
    if (fabs(SpatialDefRate[0] - SpatialVelocityGrad(0, 0)) < 0.0000001)
  ...
  template <>
  void UpdatedLagrangianElement<3>::CalcVolumetricDefRate(const ShapeFunctionDerivativesType &rDN_DX,
                                                          double &volumetricDefRate,
                                                          MatrixType &invGradDef,
                                                          const double theta)
  {
  ...
  template <>
  void UpdatedLagrangianElement<3>::CheckStrain1(double &VolumetricDefRate,
                                                 MatrixType &SpatialVelocityGrad)
  {
  ...
  template <>
  void UpdatedLagrangianElement<3>::CheckStrain2(MatrixType &SpatialVelocityGrad,
                                                 MatrixType &Fgrad,
                                                 MatrixType &VelDefgrad)
  {
