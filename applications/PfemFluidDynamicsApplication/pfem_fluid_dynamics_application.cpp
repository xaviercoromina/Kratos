...
namespace Kratos
{
  ...
  void KratosPfemFluidDynamicsApplication::Register()
  {
    ...
    KRATOS_REGISTER_VARIABLE(INERTIAL_FORCES_NORM);
    KRATOS_REGISTER_VARIABLE(VISCOUS_FORCES_NORM);
    KRATOS_REGISTER_VARIABLE(VOLUMETRIC_FORCES_NORM);
    KRATOS_REGISTER_VARIABLE(EXTERNAL_FORCES_NORM);
    KRATOS_REGISTER_VARIABLE(RHS_ELEMENTAL_NORM);
