...
PYBIND11_MODULE(KratosPfemFluidDynamicsApplication, m)
{
  ...
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INERTIAL_FORCES_NORM);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VISCOUS_FORCES_NORM);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VOLUMETRIC_FORCES_NORM);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EXTERNAL_FORCES_NORM);
  KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RHS_ELEMENTAL_NORM);
}
