...
void KratosPoromechanicsApplication::Register()
{
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( INTERNAL_FORCE_OLDER )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_FORCE_OLDER )
    KRATOS_REGISTER_VARIABLE( FLUX_RESIDUAL )
    KRATOS_REGISTER_VARIABLE( G_COEFFICIENT )
    KRATOS_REGISTER_VARIABLE( THETA_FACTOR )
    KRATOS_REGISTER_VARIABLE( DELTA )
    KRATOS_REGISTER_VARIABLE( DELTA_B )
    KRATOS_REGISTER_VARIABLE( RAYLEIGH_ALPHA_B )
    KRATOS_REGISTER_VARIABLE( RAYLEIGH_BETA_B )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( REFERENCE_DISPLACEMENT )
    KRATOS_REGISTER_VARIABLE( REFERENCE_FLUID_PRESSURE )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( NODAL_MASS_ARRAY )
    KRATOS_REGISTER_VARIABLE( STEPS_TO_CONVERGE )
    KRATOS_REGISTER_VARIABLE( USE_NODAL_MASS_ARRAY )
    KRATOS_REGISTER_VARIABLE( B_0 )
    KRATOS_REGISTER_VARIABLE( B_1 )
    KRATOS_REGISTER_VARIABLE( B_2 )
    KRATOS_REGISTER_VARIABLE( B_B_0 )
    KRATOS_REGISTER_VARIABLE( B_B_1 )
    KRATOS_REGISTER_VARIABLE( B_B_2 )
