...
#include "custom_processes/poromechanics_l2_norm_error_process.hpp"
...
void  AddCustomProcessesToPython(pybind11::module& m)
{
    ...
    .def( py::init< ModelPart&, Parameters>());
    py::class_<PoromechanicsL2NormErrorProcess, PoromechanicsL2NormErrorProcess::Pointer, Process>
    (m, "PoromechanicsL2NormErrorProcess")
    .def( py::init< ModelPart&, Parameters>());
}
