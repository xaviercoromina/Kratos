...
PYBIND11_MODULE(KratosPoromechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, INTERNAL_FORCE_OLDER )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, EXTERNAL_FORCE_OLDER )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, DELTA )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, DELTA_B )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, RAYLEIGH_ALPHA_B )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, RAYLEIGH_BETA_B )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( m, REFERENCE_DISPLACEMENT )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, REFERENCE_FLUID_PRESSURE )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, USE_NODAL_MASS_ARRAY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, B_0 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, B_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, B_2 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, B_B_0 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, B_B_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, B_B_2 )
