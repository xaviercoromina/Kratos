...
PYBIND11_MODULE(KratosPoromechanicsApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, KAPPA_0 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, KAPPA_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, RAYLEIGH_ALPHA_1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, RAYLEIGH_BETA_1 )
