...
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( INTERNAL_FORCE_OLDER )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_FORCE_OLDER )
...
KRATOS_CREATE_VARIABLE( double, DELTA_B )
KRATOS_CREATE_VARIABLE( double, RAYLEIGH_ALPHA_B )
KRATOS_CREATE_VARIABLE( double, RAYLEIGH_BETA_B )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( REFERENCE_DISPLACEMENT )
KRATOS_CREATE_VARIABLE( double, REFERENCE_FLUID_PRESSURE )
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( NODAL_MASS_ARRAY )
KRATOS_CREATE_VARIABLE( int, STEPS_TO_CONVERGE )
KRATOS_CREATE_VARIABLE(bool, USE_NODAL_MASS_ARRAY)
KRATOS_CREATE_VARIABLE( double, B_0 )
KRATOS_CREATE_VARIABLE( double, B_1 )
KRATOS_CREATE_VARIABLE( double, B_2 )
KRATOS_CREATE_VARIABLE( double, B_B_0 )
KRATOS_CREATE_VARIABLE( double, B_B_1 )
KRATOS_CREATE_VARIABLE( double, B_B_2 )
