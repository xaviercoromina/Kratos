...
KRATOS_CREATE_VARIABLE( double, KAPPA_0 )
KRATOS_CREATE_VARIABLE( double, KAPPA_1 )
KRATOS_CREATE_VARIABLE( double, RAYLEIGH_ALPHA_1 )
KRATOS_CREATE_VARIABLE( double, RAYLEIGH_BETA_1 )
