...
class OptimizationInfo:
    def __init__(self, echo_level: int = 0):
        # objects registry
        self.__optimization_routines: 'dict[str, any]' = {}
    ...
    def GetOptimizationRoutines(self, category: any) -> 'list[any]':
        if not self.HasOptimizationRoutineType(category):
    ...
    def GetSolutionStepData(self, solution_step_index: int) -> any:
