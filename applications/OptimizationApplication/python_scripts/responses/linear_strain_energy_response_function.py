...
class LinearStrainEnergyResponseFunction(ResponseFunction):
    ...
    def CalculateValue(self) -> float:
        ...
        return KratosOA.ResponseUtilities.LinearStrainEnergyResponseUtilities.CalculateStrainEnergy(self.model_part)
    ...
    def CalculateSensitivity(self, sensitivity_variable: any, sensitivity_model_part: Kratos.ModelPart):
        ...
        if sensitivity_variable == Kratos.SHAPE_SENSITIVITY:
            KratosOA.ResponseUtilities.LinearStrainEnergyResponseUtilities.CalculateStrainEnergyShapeSensitivity(sensitivity_model_part, self.perturbation_size, sensitivity_variable)
            ...
            KratosOA.ResponseUtilities.LinearStrainEnergyResponseUtilities.CalculateStrainEnergyElementPropertiesSensitivity(sensitivity_model_part, self.perturbation_size, primal_variable, sensitivity_variable)
        else:
