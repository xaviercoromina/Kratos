...
PYBIND11_MODULE(KratosOptimizationApplication, m)
{
    ...
    auto response_utilities = m.def_submodule("ResponseUtilities");
    AddCustomResponseUtilitiesToPython(response_utilities);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, SCALAR_CONTROL_UPDATE);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ARRAY3_CONTROL_UPDATE);
  }
