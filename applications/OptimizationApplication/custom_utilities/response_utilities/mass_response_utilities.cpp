...
bool MassResponseUtilities::HasVariableInProperties(
...
double MassResponseUtilities::CalculateMass(const ModelPart& rModelPart)
{
    KRATOS_TRY
...
void MassResponseUtilities::CalculateMassShapeSensitivity(
...
void MassResponseUtilities::CalculateMassDensitySensitivity(
    ModelPart& rModelPart,
...
void MassResponseUtilities::CalculateMassThicknessSensitivity(
    ModelPart& rModelPart,
    const Variable<double>& rOutputSensitivityVariable)
{
...
void MassResponseUtilities::CalculateMassCrossAreaSensitivity(
    ModelPart& rModelPart,
    const Variable<double>& rOutputSensitivityVariable)
{
...
void MassResponseUtilities::CalculateMassGeometricalPropertySensitivity(
    ModelPart& rModelPart,
