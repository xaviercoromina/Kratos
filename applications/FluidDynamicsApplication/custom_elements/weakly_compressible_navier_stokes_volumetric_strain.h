...
class WeaklyCompressibleNavierStokesVolumetricStrain : public FluidElement<TElementData>
{
public:
    ///@name Type Definitions
    ///@{

    /// Pointer definition of WeaklyCompressibleNavierStokesVolumetricStrain
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(WeaklyCompressibleNavierStokesVolumetricStrain);
     ...
     */
    WeaklyCompressibleNavierStokesVolumetricStrain(IndexType NewId = 0);
     ...
     */
    WeaklyCompressibleNavierStokesVolumetricStrain(
        IndexType NewId,
    ...
    /// Destructor.
    virtual ~WeaklyCompressibleNavierStokesVolumetricStrain();

    /// Copy constructor.
    WeaklyCompressibleNavierStokesVolumetricStrain(WeaklyCompressibleNavierStokesVolumetricStrain const &rOther) = delete;
    ...
    /// Assignment operator.
    WeaklyCompressibleNavierStokesVolumetricStrain &operator=(WeaklyCompressibleNavierStokesVolumetricStrain const &rOther) = delete;
    ...
    /**
     * Returns a pointer to a new WeaklyCompressibleNavierStokesVolumetricStrain element, created using given input.
...
private:
    ...
    ///@}
}; // Class WeaklyCompressibleNavierStokesVolumetricStrain
...
inline std::istream& operator >>(
    ...
    WeaklyCompressibleNavierStokesVolumetricStrain<TElementData>& rThis)
{
    return rIStream;
}
...
inline std::ostream& operator <<(
    ...
    const WeaklyCompressibleNavierStokesVolumetricStrain<TElementData>& rThis)
{
