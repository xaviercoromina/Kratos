...
from KratosMultiphysics.StructuralMechanicsApplication.rve_analysis_borja import RVEAnalysis
...
class TestRVESimplestTest(KratosUnittest.TestCase):
    ...
    def test_rve_computation_block_version(self):
        ...
        with KratosUnittest.WorkFolderScope(".", __file__):
            with open("rve_test/smallest_rve_test_parameters_borja_2D.json", 'r') as parameter_file:
        ...
        if parameters["rve_settings"]["print_rve_post"].GetBool():
            parameters["output_processes"].AddValue("gid_output", KratosMultiphysics.Parameters(R'''[{
                ...
                "Parameters"    : {
                    ...
                    "output_name"            : "rve_test/smallest_rve_test_borja_2D",
