...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MASS_ARRAY_SCALE_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MASS_ARRAY_AVERAGING_TIME_INTERVAL)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, NODAL_MASS_ARRAY_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
