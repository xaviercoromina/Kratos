...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, USE_MASS_ARRAY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MASS_ARRAY_AVERAGING_TIME_INTERVAL)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ESTIMATED_NODAL_MASS_ARRAY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ESTIMATED_NODAL_MASS_ARRAY_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INERTIA_ARRAY_SCALE_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, OMEGA_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, OMEGA_N)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, XI_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, XI_N)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_CONVERGED_ONCE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, XI_1_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, OMEGA_1_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, OMEGA_N_FACTOR)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, VELOCITY_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ANGULAR_VELOCITY_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, REACTION_OLD)
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, REACTION_MOMENT_OLD)
