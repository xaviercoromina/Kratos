...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, USE_MASS_ARRAY)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MASS_ARRAY_AVERAGING_TIME_INTERVAL)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ESTIMATED_NODAL_MASS_ARRAY)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ESTIMATED_NODAL_MASS_ARRAY_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, INERTIA_ARRAY_SCALE_FACTOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, OMEGA_1)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, OMEGA_N)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, XI_1)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, XI_N)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, IS_CONVERGED_ONCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, XI_1_FACTOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, OMEGA_1_FACTOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, OMEGA_N_FACTOR)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, ANGULAR_VELOCITY_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, REACTION_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, REACTION_MOMENT_OLD)
