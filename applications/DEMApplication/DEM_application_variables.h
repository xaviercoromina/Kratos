...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MASS_ARRAY_SCALE_FACTOR)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, MASS_ARRAY_AVERAGING_TIME_INTERVAL)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, NODAL_MASS_ARRAY_OLD)
  KRATOS_DEFINE_3D_APPLICATION_VARIABLE_WITH_COMPONENTS(DEM_APPLICATION, PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, bool, IS_CONVERGED)
