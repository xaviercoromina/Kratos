...
KRATOS_CREATE_VARIABLE(bool, USE_MASS_ARRAY)
KRATOS_CREATE_VARIABLE(double, MASS_ARRAY_AVERAGING_TIME_INTERVAL)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_NODAL_MASS_ARRAY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_NODAL_MASS_ARRAY_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
KRATOS_CREATE_VARIABLE(double, INERTIA_ARRAY_SCALE_FACTOR)
KRATOS_CREATE_VARIABLE(double, OMEGA_1)
KRATOS_CREATE_VARIABLE(double, OMEGA_N)
KRATOS_CREATE_VARIABLE(double, XI_1)
KRATOS_CREATE_VARIABLE(double, XI_N)
KRATOS_CREATE_VARIABLE(bool, IS_CONVERGED_ONCE)
KRATOS_CREATE_VARIABLE(double, XI_1_FACTOR)
KRATOS_CREATE_VARIABLE(double, OMEGA_1_FACTOR)
KRATOS_CREATE_VARIABLE(double, OMEGA_N_FACTOR)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_VELOCITY_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(REACTION_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(REACTION_MOMENT_OLD)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(USE_MASS_ARRAY)
    KRATOS_REGISTER_VARIABLE(MASS_ARRAY_AVERAGING_TIME_INTERVAL)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_NODAL_MASS_ARRAY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_NODAL_MASS_ARRAY_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
    KRATOS_REGISTER_VARIABLE(INERTIA_ARRAY_SCALE_FACTOR)
    KRATOS_REGISTER_VARIABLE(OMEGA_1)
    KRATOS_REGISTER_VARIABLE(OMEGA_N)
    KRATOS_REGISTER_VARIABLE(XI_1)
    KRATOS_REGISTER_VARIABLE(XI_N)
    KRATOS_REGISTER_VARIABLE(IS_CONVERGED_ONCE)
    KRATOS_REGISTER_VARIABLE(XI_1_FACTOR)
    KRATOS_REGISTER_VARIABLE(OMEGA_1_FACTOR)
    KRATOS_REGISTER_VARIABLE(OMEGA_N_FACTOR)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_NODAL_MASS_ARRAY_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(GLOBALLY_ESTIMATED_PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ANGULAR_VELOCITY_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(REACTION_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(REACTION_MOMENT_OLD)
