...
KRATOS_CREATE_VARIABLE(double, MASS_ARRAY_SCALE_FACTOR)
KRATOS_CREATE_VARIABLE(double, MASS_ARRAY_AVERAGING_TIME_INTERVAL)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(NODAL_MASS_ARRAY_OLD)
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(MASS_ARRAY_SCALE_FACTOR)
    KRATOS_REGISTER_VARIABLE(MASS_ARRAY_AVERAGING_TIME_INTERVAL)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(NODAL_MASS_ARRAY_OLD)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(PARTICLE_MOMENT_OF_INERTIA_ARRAY_OLD)
