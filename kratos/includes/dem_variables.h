...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE( double, NUMBER_OF_PARTICLES_IN_A_ION_MACROPARTICLE )
    KRATOS_DEFINE_VARIABLE( double, NUMBER_OF_PARTICLES_IN_A_ELECTRON_MACROPARTICLE )
    KRATOS_DEFINE_VARIABLE( double, MACROPARTICLE_ION_DENSITY )
    KRATOS_DEFINE_VARIABLE( double, MACROPARTICLE_ELECTRON_DENSITY )
    KRATOS_DEFINE_VARIABLE( double, FLUID_ION_DENSITY )
    KRATOS_DEFINE_VARIABLE( double, FLUID_ELECTRON_DENSITY )
    KRATOS_DEFINE_VARIABLE( double, FLUID_NEUTRAL_DENSITY )  
    KRATOS_DEFINE_APPLICATION_VARIABLE( PLASMA_DYNAMICS_APPLICATION, Vector,NODAL_WEIGHTS)   
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_ELECTRIC_FIELD )   
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD_PROJECTED_TO_PARTICLE )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_MAGNETIC_FIELD )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( MAGNETIC_FIELD )
    KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS( PARTICLE_ION_VELOCITY )
