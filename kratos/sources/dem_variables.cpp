...
namespace Kratos
{
    ...
    // Plasma Dynamics Application BEGIN

    KRATOS_CREATE_VARIABLE( double, ELECTRIC_POTENTIAL )
    KRATOS_CREATE_VARIABLE( double, NUMBER_OF_PARTICLES_IN_A_ION_MACROPARTICLE )
    KRATOS_CREATE_VARIABLE( double, NUMBER_OF_PARTICLES_IN_A_ELECTRON_MACROPARTICLE )    
    KRATOS_CREATE_VARIABLE( double, MACROPARTICLE_ION_DENSITY )
    KRATOS_CREATE_VARIABLE( double, MACROPARTICLE_ELECTRON_DENSITY )
    KRATOS_CREATE_VARIABLE( double, FLUID_ION_DENSITY )
    KRATOS_CREATE_VARIABLE( double, FLUID_ELECTRON_DENSITY )
    KRATOS_CREATE_VARIABLE( double, FLUID_NEUTRAL_DENSITY )  
    KRATOS_CREATE_VARIABLE(Vector, NODAL_WEIGHTS)
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_ELECTRIC_FIELD )      
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_MAGNETIC_FIELD )     
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( MAGNETIC_FIELD )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( PARTICLE_ION_VELOCITY )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD_PROJECTED_TO_PARTICLE )

    // Plasma Dynamics Application END

    // Fluid Transport Application BEGIN
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( NODAL_PHI_GRADIENT )
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS( PHI_GRADIENT )
    // Fluid Transport Application END
  ...
  void KratosApplication::RegisterDEMVariables()
  {
    ...
    KRATOS_REGISTER_VARIABLE( NUMBER_OF_PARTICLES_IN_A_ION_MACROPARTICLE )
    KRATOS_REGISTER_VARIABLE( NUMBER_OF_PARTICLES_IN_A_ELECTRON_MACROPARTICLE )
    KRATOS_REGISTER_VARIABLE( MACROPARTICLE_ION_DENSITY )    
    KRATOS_REGISTER_VARIABLE( MACROPARTICLE_ELECTRON_DENSITY )      
    KRATOS_REGISTER_VARIABLE( FLUID_ION_DENSITY )
    KRATOS_REGISTER_VARIABLE( FLUID_ELECTRON_DENSITY )
    KRATOS_REGISTER_VARIABLE( FLUID_NEUTRAL_DENSITY )      
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_ELECTRIC_FIELD )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( EXTERNAL_MAGNETIC_FIELD )          
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( MAGNETIC_FIELD )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( PARTICLE_ION_VELOCITY )
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD_PROJECTED_TO_PARTICLE )
