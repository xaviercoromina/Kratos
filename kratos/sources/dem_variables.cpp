...
namespace Kratos
{
  ...
  void KratosApplication::RegisterDEMVariables()
  {
    ...
    KRATOS_REGISTER_VARIABLE( double, ELECTRIC_POTENTIAL )
    KRATOS_REGISTER_VARIABLE( double, MACROPARTICLE_ION_DENSITY )
    KRATOS_REGISTER_VARIABLE( double, FLUID_ION_DENSITY )
    KRATOS_REGISTER_VARIABLE( double, FLUID_ELECTRON_DENSITY )
    KRATOS_REGISTER_VARIABLE( double, FLUID_NEUTRAL_DENSITY )        
