...
void  AddDEMVariablesToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, ELECTRIC_POTENTIAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, NUMBER_OF_PARTICLES_IN_A_ION_MACROPARTICLE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, NUMBER_OF_PARTICLES_IN_A_ELECTRON_MACROPARTICLE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, MACROPARTICLE_ION_DENSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, MACROPARTICLE_ELECTRON_DENSITY )    
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, FLUID_ION_DENSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, FLUID_ELECTRON_DENSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( m, FLUID_NEUTRAL_DENSITY ) 
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, NODAL_WEIGHTS ) 
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, EXTERNAL_ELECTRIC_FIELD )          
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ELECTRIC_FIELD )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, EXTERNAL_MAGNETIC_FIELD )    
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, MAGNETIC_FIELD )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, PARTICLE_ION_VELOCITY )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, ELECTRIC_FIELD_PROJECTED_TO_PARTICLE )
