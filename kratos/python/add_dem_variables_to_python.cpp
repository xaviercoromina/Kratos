...
void  AddDEMVariablesToPython(pybind11::module& m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( double, ELECTRIC_POTENTIAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( double, MACROPARTICLE_ION_DENSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( double, FLUID_ION_DENSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( double, FLUID_ELECTRON_DENSITY )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( double, FLUID_NEUTRAL_DENSITY )        
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( MAGNETIC_FIELD )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( PARTICLE_ION_VELOCITY )
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS( ELECTRIC_FIELD_PROJECTED_TO_PARTICLE )
