...
using MatrixResultsType = std::vector<std::vector<double>>;
using EqIDVectorResultsType = std::vector<int> ;
                                   ...
                                   const Geometry<NodeType>::Pointer pGeom)
{
    ...
    SearchInterfaceInfo::Pointer p_nearest_elem_info(Kratos::make_shared<NearestElementInterfaceInfo>(local_sys.Coordinates(), 0, 0));
...
KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_BasicTests, KratosCoreFastSuite)
{
    ...
    KRATOS_CHECK_STRING_EQUAL(str_steam.str(), "NearestElementLocalSystem based on Node #8 at Coordinates 1 | 2.5 | -5");
}

KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_ComputeLocalSystem_Line, KratosCoreFastSuite)
{
...
KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_ComputeLocalSystem_Triangle, KratosCoreFastSuite)
{
    auto node_1(Kratos::make_intrusive<NodeType>(1, 0.0, 0.0, 0.0));
    auto node_2(Kratos::make_intrusive<NodeType>(2, 1.0, 0.0, 0.0));
...
KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_ComputeLocalSystem_Quad, KratosCoreFastSuite)
{
    auto node_1(Kratos::make_intrusive<NodeType>(1, 0.0, 0.0, 0.0));
    auto node_2(Kratos::make_intrusive<NodeType>(2, 1.0, 0.0, 0.0));
    auto node_3(Kratos::make_intrusive<NodeType>(3, 1.0, 1.0, 0.0));
...
KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_ComputeLocalSystem_Tetra, KratosCoreFastSuite)
{
    auto node_1(Kratos::make_intrusive<NodeType>(1, 0.0, 0.0, 0.0));
    auto node_2(Kratos::make_intrusive<NodeType>(2, 1.0, 0.0, 0.0));
...
KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_ComputeLocalSystem_Hexa, KratosCoreFastSuite)
{
    auto node_1(Kratos::make_intrusive<NodeType>(1, 0.0, 0.0, 0.0));
    auto node_2(Kratos::make_intrusive<NodeType>(2, 1.0, 0.0, 0.0));
    auto node_3(Kratos::make_intrusive<NodeType>(3, 1.0, 1.0, 0.0));
...
KRATOS_TEST_CASE_IN_SUITE(NearestElementLocalSystem_ComputeLocalSystemWithApproximation, KratosCoreFastSuite)
{
