...
#include "solving_strategies/convergencecriterias/mixed_generic_residual_criteria.h"
...
namespace Testing
{
    ...
    typedef MixedGenericResidualCriteria<SparseSpaceType, LocalSpaceType> MixedGenericResidualCriteriaType;
    typedef typename MixedGenericResidualCriteriaType::ConvergenceVariableListType ConvergenceVariableListType;

    void GenerateTestResidualConvergenceCriteriaModelPart(ModelPart& rModelPart)
    {
        // Model part settings
     ...
     */
    KRATOS_TEST_CASE_IN_SUITE(MixedGenericResidualCriteriaDoubleDouble, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("TestModelPart");

        // Set the test model part
        GenerateTestResidualConvergenceCriteriaModelPart(r_model_part); // Create the geometry
        ...
        auto mixed_generic_criteria = MixedGenericResidualCriteriaType(convergence_settings);
     ...
     */
    KRATOS_TEST_CASE_IN_SUITE(MixedGenericResidualCriteriaDoubleVector, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("TestModelPart");
     ...
     * Checks the mixed generic criteria with a double and a vector variable
     */
    KRATOS_TEST_CASE_IN_SUITE(MixedGenericResidualCriteriaDoubleVectorWithParameters, KratosCoreFastSuite)
    {
        Model current_model;
        ModelPart& r_model_part = current_model.CreateModelPart("TestModelPart");
        ...
        auto mixed_generic_criteria = MixedGenericResidualCriteriaType(parameters);
