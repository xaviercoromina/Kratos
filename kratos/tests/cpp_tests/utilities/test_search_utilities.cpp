...
KRATOS_TEST_CASE_IN_SUITE(SearchUtilities_ComputeLocalBoundingBox, KratosCoreFastSuite)
{
    Model current_model;
    ...
    const auto bbox = SearchUtilities::ComputeLocalBoundingBox(model_part);
...
KRATOS_TEST_CASE_IN_SUITE(SearchUtilities_ComputeGlobalBoundingBox, KratosCoreFastSuite)
{
    Model current_model;
    ModelPart& model_part = current_model.CreateModelPart("Generated");
...
KRATOS_TEST_CASE_IN_SUITE(SearchUtilities_ComputeBoundingBoxWithTol, KratosCoreFastSuite)
{
    ...
    KRATOS_DEBUG_CHECK_EXCEPTION_IS_THROWN(SearchUtilities::ComputeBoundingBoxesWithTolerance(bboxes_wrong_size, 1.235, bboxes_with_tol), "Error: Bounding Boxes size has to be a multiple of 6!");
...
KRATOS_TEST_CASE_IN_SUITE(SearchUtilities_FillBufferBeforeLocalSearch, KratosCoreFastSuite)
{
    ...
    SearchLocalSystemPointerVector local_systems;
    ...
    KRATOS_DEBUG_CHECK_EXCEPTION_IS_THROWN(SearchUtilities::FillBufferBeforeLocalSearch(
        local_systems,
    ...
    SearchUtilities::FillBufferBeforeLocalSearch(
        local_systems,
        bounding_boxes,
        buffer_size_estimate,
        send_buffer,
...
KRATOS_TEST_CASE_IN_SUITE(SearchUtilities_CreateSearchInterfaceInfosFromBuffer, KratosCoreFastSuite)
{
    ...
    SearchInterfaceInfoPointerVectorType interface_info_container;

    SearchInterfaceInfoUniquePointerType p_ref_interface_info(Kratos::make_unique<NearestNeighborInterfaceInfo>());

    // throws bcs "interface_info_container" has the wrong size
    KRATOS_DEBUG_CHECK_EXCEPTION_IS_THROWN(SearchUtilities::CreateSearchInterfaceInfosFromBuffer(
        recv_buffer,
    ...
    SearchUtilities::CreateSearchInterfaceInfosFromBuffer(
        recv_buffer,
        p_ref_interface_info,
        comm_rank,
        interface_info_container);
...
KRATOS_TEST_CASE_IN_SUITE(SearchUtilities_SearchInterfaceInfoSerializer, KratosCoreFastSuite)
{
    // this test checks if the serialization/deserialization of the Helper-Class that
    // serializes/deserializes the SearchInterfaceInfos works correctly
    ...
    typedef Kratos::shared_ptr<SearchInterfaceInfo> SearchInterfaceInfoPointerType;
    typedef std::vector<std::vector<SearchInterfaceInfoPointerType>> SearchInterfaceInfoPointerVectorType;

    // A "NearestNeighborInterfaceInfo" is being used since "SearchInterfaceInfo" is a pure virtual class
    ...
    SearchInterfaceInfoPointerType p_nearest_neighbor_info_1(
        Kratos::make_shared<NearestNeighborInterfaceInfo>(coords_1, source_local_sys_idx_1, 0));
    SearchInterfaceInfoPointerType p_nearest_neighbor_info_2(
        Kratos::make_shared<NearestNeighborInterfaceInfo>(coords_2, source_local_sys_idx_2, 0));
    SearchInterfaceInfoPointerType p_nearest_neighbor_info_3(
    ...
    p_nearest_neighbor_info_1->GetValue(found_id, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_EQUAL(found_id[0], expected_id_found_1);
    double neighbor_dist;
    p_nearest_neighbor_info_1->GetValue(neighbor_dist, SearchInterfaceInfo::InfoType::Dummy);
    ...
    // Now some the checks are performed to make sure the objects are correctly initialized
    p_nearest_neighbor_info_2->GetValue(found_id, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_EQUAL(found_id[0], expected_id_found_2);
    p_nearest_neighbor_info_2->GetValue(neighbor_dist, SearchInterfaceInfo::InfoType::Dummy);
    ...
    // Now some the checks are performed to make sure the objects are correctly initialized
    p_nearest_neighbor_info_3->GetValue(found_id, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_EQUAL(found_id[0], expected_id_found_3);
    p_nearest_neighbor_info_3->GetValue(neighbor_dist, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_DOUBLE_EQUAL(neighbor_dist, dist_3_3);

    // Now finally we can construct the container
    SearchInterfaceInfoPointerVectorType interface_info_container(2);
    ...
    const Kratos::unique_ptr<SearchInterfaceInfo> p_ref_nearest_neighbor_info(Kratos::make_unique<NearestNeighborInterfaceInfo>());

    SearchInterfaceInfoSerializer serializer_helper_0(
        interface_info_container[0], p_ref_nearest_neighbor_info );
    SearchInterfaceInfoSerializer serializer_helper_1(
    ...
    SearchInterfaceInfoPointerVectorType interface_info_container_new(2);

    SearchInterfaceInfoSerializer serializer_helper_new_0(
        interface_info_container_new[0], p_ref_nearest_neighbor_info );

    SearchInterfaceInfoSerializer serializer_helper_new_1(
    ...
    r_info_1->GetValue(found_id, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_EQUAL(found_id[0], expected_id_found_1);
    r_info_2->GetValue(found_id, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_EQUAL(found_id[0], expected_id_found_2);
    r_info_3->GetValue(found_id, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_EQUAL(found_id[0], expected_id_found_3);

    r_info_1->GetValue(neighbor_dist, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_DOUBLE_EQUAL(neighbor_dist, dist_1_1);
    r_info_2->GetValue(neighbor_dist, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_DOUBLE_EQUAL(neighbor_dist, dist_2_2);
    r_info_3->GetValue(neighbor_dist, SearchInterfaceInfo::InfoType::Dummy);
    KRATOS_CHECK_DOUBLE_EQUAL(neighbor_dist, dist_3_3);
